...
*                                                                                *
*	void Draw (void);                                                            *
*		Perform All Your Scene Drawing  (used to, no need of it now)             *
*                                                                                *
*********************************************************************************/
...
BOOL Initialize (GL_Window* window, Keys* keys, MouseCoords* mouseCoord);	// Performs All Your Initialization

void Deinitialize (void);							// Performs All Your DeInitialization

void Update (DWORD milliseconds, HDC hDC);					// Perform Motion Updates
